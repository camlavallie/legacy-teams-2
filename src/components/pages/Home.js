            ...
            <Col sm={12}>
              <Jumbotron fluid className="jumbo-home">
                <Container>
                  ...
                  for God. Our backgrounds consists of extensive military experience, marriage and family ministries, professional counseling, life coaching, church and business administration, and inner healing ministries. Our desire is to help military chaplains, veterans, civilian ministers and their families achieve wholeness, healing and strength to serve God and build godly legacies in their lives.
                  </p>
                </Container>
              </Jumbotron>
            </Col>
            ...
            <Col sm={12}>
              <Jumbotron fluid className="jumbo-home-bottom">
                <Container>
                  ...
                  <p>
                    WHAT'S THE BEST WAY TO CONTACT LEGACY TEAMS?<br/>
                  Simply email us at chaplainegert@yahoo.com. We'll get back to you within 24 hours.<br/><hr/>

                  I’ M MARRIED. IS IT NECESSARY THAT MY SPOUSE ALSO PARTICIPATE IN MEETINGS WITH LEGACY TEAMS ? <br/>
                    No. You are welcome to contact us privately, and we can work with you individually.In most cases, however, we want to work with both spouses to achieve marital and family wellness. <br/> <hr/>

                    WHAT SHOULD I EXPECT FROM LEGACY TEAMS IN TERMS OF ASSISTANCE ? <br/>
                    Much of your work with Legacy TEAMS can be conducted by calls and teleconferencing.  Pending the needs of an individual or couple, we may recommend a marriage engagement (face to face intensive) with the location to be determined. Engagements vary in length from two to six days with proportionate costs. <br/> <hr/>

                    HOW MUCH DOES IT COST TO WORK WITH LEGACY TEAM ? <br/>
                    Costs vary based on whether one or two individuals (i.e., a couple) are receiving assistance and which members of Legacy TEAMS are providing care.A schedule offees will be forwarded upon request. Fees may fluctuate based on the situation of individuals. Legacy TEAMS receives donations and gifts to keep ministry costs affordable. 
                    </p>
                </Container>
              </Jumbotron>
            </Col>
