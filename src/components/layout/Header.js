    ...
    return (
      <div>
        <Navbar className="navbar"  expand="lg" >
          <Navbar.Brand href="/home" style={{marginLeft:'25px', fontSize:'35px'}}>LegacyTEAMS<br/><p style={{fontSize:"14px", fontFamily:'Cormorant', opacity:".8", marginTop:'5px', marginBottom:'5px'}}>Transforming, Encouraging, and Assessing Mission Strength.</p></Navbar.Brand>
